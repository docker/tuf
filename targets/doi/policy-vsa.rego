# doi/policy-vsa.rego verifies and validates the Verification Summary Attestation (VSA) attached to the image.
#   The VSA is generated by evaluating doi/policy-full.rego and is a verification summary of all attestations.
package attest
